...
```
Accedemos con la contrasena anterior para posteriormente con ssh intentar acceder a sshkey.private
despuemos accedemos con cat a /etc/bandit_pass/bandit14
